...
export function LoginPage() {
  return (
    <main className="grid min-h-screen overflow-hidden lg:grid-cols-[minmax(470px,46%)_1fr]">
      <section
      ...
      >
        ...
        <img src={logoKrontec} alt="Krontec" className="relative z-10 w-[min(20vw,19.4rem)]" />
      ...
      <section className="flex min-h-screen flex-col items-center justify-center bg-[radial-gradient(circle_at_top_right,rgba(106,182,239,0.08),transparent_26rem)] px-4 py-10 sm:px-10">
        <div className="mb-6 flex items-center lg:hidden">
          <img src={logoKrontec} alt="Krontec" className="h-auto w-48" />
        </div>

        <LoginForm />

        <footer className="mt-8 text-center text-sm text-[#6c7789]">
